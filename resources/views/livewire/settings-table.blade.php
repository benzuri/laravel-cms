            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    <div class="flex flex-row gap-3 mb-3">
                        <x-dashboard-crud-search title="settings" />
                                ...
                                <tr>
                                    <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                        <div class="flex items-center">
                                            <button wire:click="sortByField('key')" class="text-xs font-medium uppercase {{ $sortBy=='key' ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-300' }}">Key</button>
    ...
    <x-dialog-modal wire:model="confirmingItemAdd">
        ...
        <x-slot name="content">
            <div class="">
                ...
                <x-input id="key" type="text" wire:model="item.key" class="mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                <x-input-error for="item.key" class="mt-2" />
            </div>
            <div class="mt-4">
                <x-label for="value" value="{{ __('Value') }}" />
                <x-input id="value" type="text" wire:model.defer="item.value" class="mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                <x-input-error for="item.value" class="mt-2" />
            </div>
        </x-slot>
